...
public class Sermon_wed_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        page_num=1;
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_sermon_wed_fragment, container, false);

        TextView text_sermon_type = rootView.findViewById(R.id.text_sermon_wed_type);
        text_sermon_type.setText(catalogue_b);
        recyclerView = rootView.findViewById(R.id.wed_recycler_view);
    ...
    private void findview_setting(ViewGroup rootView) {
        start_text = rootView.findViewById(R.id.wed_list_start_text);
        text_1 = rootView.findViewById(R.id.wed_list_1_text);
        text_2 = rootView.findViewById(R.id.wed_list_2_text);
        text_3 = rootView.findViewById(R.id.wed_list_3_text);
        text_4 = rootView.findViewById(R.id.wed_list_4_text);
        text_5 = rootView.findViewById(R.id.wed_list_5_text);
        last_text = rootView.findViewById(R.id.wed_list_last_text);
    }

    public Sermon_wed_fragment(ArrayList<Preach_bbs> preach_bbs, String catalogue_b){
